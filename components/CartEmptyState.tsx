...
const COPY = {
  heroIcon: "cart" as HubMenuIconName,
  ctaIcon: "discover" as const,
  title: "Your cart is empty",
  subtitle:
    "Swipe right on listings you love, pick a quantity, and they’ll show up here — ready to review and check out.",
  primaryLabel: "Browse Discover",
  steps: [
    "Open a listing and tap the heart to like it",
    "Choose how many units you want on the line",
    "Come back here anytime to checkout",
  ],
} as const;

/**
 * Empty cart — matches favorites / orders empty states (hero tile, steps, gradient CTA).
 */
export function CartEmptyState({ onBrowseDiscover }: Props) {
